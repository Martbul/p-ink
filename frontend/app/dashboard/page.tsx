...
function PairFramePanel({ onPaired }: { onPaired: () => void }) {
  ...
  return (
    <div className="group relative bg-surface-dark border border-neon-blue/30 p-7 transition-all duration-500 hover:border-neon-blue/70 hover:shadow-[0_0_20px_rgba(5,217,232,0.15)]" style={{ clipPath: polyClip }}>
      ...
      <div className="relative z-10">
        ...
        {!open ? (
          <button
            onClick={() => setOpen(true)}
            className="flex items-center gap-2.5 text-xs font-mono font-bold uppercase tracking-widest text-neon-blue hover:text-white transition-colors"
          >
          ...
          <div className="flex flex-col gap-3">
            ...
            <button onClick={() => setOpen(false)} className="text-[10px] font-mono text-text-muted uppercase hover:text-white text-left mt-2">
              [ Cancel Operation ]
            </button>
          </div>
        )}
...
function InvitePartnerPanel() {
  ...
  return (
    <div className="group relative bg-surface-dark border border-neon-purple/30 p-7 transition-all duration-500 hover:border-neon-purple/70 hover:shadow-[0_0_20px_rgba(177,34,229,0.15)]" style={{ clipPath: polyClipReverse }}>
      ...
      <div className="relative z-10">
        ...
        {!inviteURL ? (
          <button
            onClick={generate}
            disabled={loading}
            className="flex items-center gap-2.5 text-xs font-mono font-bold uppercase tracking-widest text-neon-purple hover:text-white transition-colors disabled:opacity-40"
          >
