    ...
    <>
      ...
      >
        ...
        {!open ? (
          ...
          >
            Click to enter MAC <ArrowRight size={10} />
          </span>
        ) : (
          <div className="flex gap-2" onClick={(e) => e.stopPropagation()}>
            ...
            <button
              ...
              className="font-mono text-[10px] uppercase px-2 flex items-center justify-center"
        ...
        {mode === "invite" && (
          <div className="flex flex-col gap-2 mt-2">
            ...
            {inviteURL && (
              <>
                <div className="flex gap-2">
                  ...
                  <button
                    onClick={copy}
                    className="px-3 font-mono text-[9px] uppercase font-bold tracking-widest shrink-0 transition-all flex items-center justify-center"
                    style={{
                      clipPath: polyXs,
            ...
            <button
              ...
              className="flex items-center gap-1 font-mono text-[9px] uppercase text-left mt-1 w-fit"
              style={{ color: "rgba(255,255,255,0.2)" }}
            >
    ...
    >
      ...
      {displayed && (
        <>
          ...
          <span
            className="font-mono text-[10px] uppercase tracking-widest hidden md:block"
            style={{ color: "rgba(255,255,255,0.2)" }}
          >
            Showing:{" "}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Pill color={C.cyan} text="Frame mode" />
      </div>
      ...
      <div className="p-4 flex flex-col gap-3">
        <p
          ...
          style={{ color: "rgba(255,255,255,0.3)" }}
        >
          Upload photos, set the order, and let your partner&apos;s frame cycle
        ...
        >
          {[
            {
              icon: <Play size={12} />,
              label: "Sequential, shuffle, random or loop-one",
            },
            {
              icon: <Timer size={12} />,
              label: "Per-slide or global duration control",
            },
            {
              icon: <Moon size={12} />,
              label: "Night mode — auto-dims between set hours",
            },
            {
              icon: <Heart size={12} />,
              label: "Partner reacts to each slide with emoji",
            },
          ].map(({ icon, label }) => (
            <div key={label} className="flex items-center gap-2">
              <span className="flex items-center justify-center text-[rgba(255,255,255,0.4)]">
                {icon}
              </span>
              <span
        ...
        <Link
          ...
          className="flex items-center justify-center gap-2 font-mono text-[10px] uppercase font-bold tracking-widest py-2.5 transition-all"
          style={{
            clipPath: polySm,
            background: `${C.cyan}12`,
          ...
          onMouseEnter={(e) => {
            ...
            el.style.background = C.cyan;
            el.style.color = "#07070f";
          }}
          onMouseLeave={(e) => {
            const el = e.currentTarget as HTMLAnchorElement;
            el.style.background = `${C.cyan}12`;
            ...
            <>
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-3 font-mono text-[10px] uppercase tracking-widest flex items-center justify-center"
                  style={{
                    clipPath: polyXs,
                    border: "1px solid rgba(255,255,255,0.1)",
                    background: "transparent",
          ...
          <div className="flex items-center gap-2">
            {(["pen", "eraser"] as const).map((t) => (
              <button
                key={t}
                onClick={() => setTool(t)}
                className="px-2 py-1 font-mono text-[8px] uppercase tracking-widest transition-all flex items-center justify-center"
                style={{
                  clipPath: polyXs,
...
function QueuePanel() {
  ...
  const typeIcon: Record<string, React.ReactNode> = {
    ...
    message: <MessageSquare size={11} />,
    drawing: <Pencil size={11} />,
  };
            ...
            {screens.map((s, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {isHome ? <Home size={10} /> : i + 1}
                  </div>
                  <span className="text-base shrink-0 text-white/80">
                    {meta?.icon}
                  </span>
                  <div className="flex-1 min-w-0">
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="absolute bottom-1 left-2 font-mono flex items-center gap-1.5 leading-none z-30"
          style={{ fontSize: "0.45rem", color: `${C.cyan}70` }}
        >
          <span className="flex items-center gap-0.5">
            <Heart size={8} fill="currentColor" /> 87
          </span>
          <span className="flex items-center gap-0.5">
            <Zap size={8} fill="currentColor" /> 64
          </span>
          <span>LVL 7</span>
        </div>
        <div
      ...
      >
          ...
          <div className="flex items-center gap-1.5">
            <Link
              ...
              onMouseEnter={(e) => {
                ...
                el.style.background = `${C.pink}20`;
              }}
              onMouseLeave={(e) => {
                const el = e.currentTarget as HTMLAnchorElement;
                el.style.borderColor = `${C.pink}40`;
                el.style.color = `${C.pink}cc`;
                el.style.background = `${C.pink}0c`;
              }}
            >
              <Palette size={10} />
              Avatar
        ...
        <p
          className="flex items-center gap-1 font-mono text-[7px] uppercase tracking-widest mt-2 pt-2"
          style={{
            color: "rgba(255,255,255,0.1)",
            borderTop: "1px solid rgba(255,255,255,0.04)",
          }}
        >
          <RefreshCw size={8} /> Partner content keeps them alive
        </p>
      </div>
      <style>{`
...
const MOB_SECTIONS = [
  { id: "pet", label: "Pet", icon: <PawPrint size={18} /> },
  { id: "photo", label: "Photo", icon: <Camera size={18} /> },
  { id: "slideshow", label: "Slide", icon: <Film size={18} /> },
  { id: "message", label: "Msg", icon: <MessageSquare size={18} /> },
  { id: "draw", label: "Draw", icon: <Pencil size={18} /> },
  { id: "screens", label: "Screens", icon: <Monitor size={18} /> },
  { id: "queue", label: "Queue", icon: <LayoutList size={18} /> },
];

export default function DashboardPage() {
  const { couple, device, isLoading, error, refetch } = useUser();
  const [mobSection, setMobSection] = useState("pet");
    ...
    <AppLayout>
      <style>{`
        ...
        @media (max-width: 600px) {
          ...
          .mob-dash { display: flex !important; }
          .dash-status { margin-bottom: 0.75rem !important; }
        }
      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 py-4 sm:py-6 pb-24 sm:pb-6">
        {setupNeeded && (
        ...
        {coupleActive && (
          <>
            <div className="mb-5 dash-status">
              <FrameStatusBar />
            </div>
            ...
            <div className="dash-grid">
              ...
              <div className="dash-col-sidebar flex flex-col gap-4">
                <TamagotchiWidget />
                <QueuePanel />
              </div>
            </div>

            <div className="mob-dash flex-col gap-4">
              <div>
                {mobSection === "pet" && <TamagotchiWidget />}
                {mobSection === "photo" && <PhotoWidget />}
                {mobSection === "slideshow" && <SlideshowWidget />}
                {mobSection === "message" && <MessageWidget />}
                {mobSection === "avatar" && (
                  <div
                    className="flex flex-col items-center justify-center gap-4 py-12"
                    style={{
                      border: `1px solid ${C.pink}25`,
                      background: `${C.pink}05`,
                      clipPath: polySm,
                    }}
                  >
                    <div className="text-[#ff2a6d] mb-2">
                      <Palette size={40} />
                    </div>
                    <div className="text-center">
                      ...
                      <p
                        className="font-bold uppercase text-base tracking-tight mb-1"
                        style={{
                          fontFamily: "'Syne', sans-serif",
                          color: "#fff",
                        }}
                      ...
                      <p
                        className="font-mono text-[10px] leading-relaxed px-6"
                        style={{ color: "rgba(255,255,255,0.3)" }}
                      >
                        Draw your avatar — it appears in the corner of
                        notifications on your partner&apos;s frame.
                      </p>
                    </div>
                    <Link
                      href="/dashboard/pixel-art"
                      className="flex items-center justify-center gap-1.5 font-mono text-[10px] uppercase font-bold tracking-widest px-6 py-3 transition-all"
                      style={{
                        clipPath: polyXs,
                        border: `1.5px solid ${C.pink}`,
                ...
                {mobSection === "draw" && <DrawWidget />}
                {mobSection === "screens" && <ScreenManagerWidget />}
                {mobSection === "queue" && <QueuePanel />}
              </div>
              ...
              >
                {MOB_SECTIONS.map((s) => {
                  const active = mobSection === s.id;
                  return (
                    <button
                      key={s.id}
                      onClick={() => setMobSection(s.id)}
                      className="flex-1 flex flex-col items-center justify-center py-2.5 gap-1 transition-all"
                      style={{
                        background: active ? `${C.cyan}0d` : "transparent",
                    ...
                    >
                      ...
                      <span
                        className="font-mono text-[8px] uppercase tracking-widest"
                        style={{
                          color: active ? C.cyan : "rgba(255,255,255,0.25)",
                        }}
                      >
                        {s.label}
                      </span>
