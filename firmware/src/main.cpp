...
// ═════════════════════════════════════════════════════════════════════════════
//  CONFIGURATION  — edit before first flash, or use provision_serial.py
// ═════════════════════════════════════════════════════════════════════════════

// Leave blank to require serial provisioning on first boot (recommended)
#define DEFAULT_WIFI_SSID ""
#define DEFAULT_WIFI_PASS ""
#define DEFAULT_API_BASE "https://api.p-ink.app"

// 0 = deep sleep (battery)  1 = light sleep  2 = active (USB/dev)
#define POWER_MODE 2
...
//  Hardware SPI: SCK=12  MOSI=11  (VSPI default on S3)
// ═════════════════════════════════════════════════════════════════════════════
#define EPD_CS 10
#define EPD_DC 9
#define EPD_RST 8
...
// ═════════════════════════════════════════════════════════════════════════════
//  DISPLAY
//  Change GxEPD2_750_T7 if you use a different panel.
//  See: https://github.com/ZinggJM/GxEPD2#supported-displays
// ═════════════════════════════════════════════════════════════════════════════
...
// Survives deep sleep — stored in RTC SRAM
...
// ═════════════════════════════════════════════════════════════════════════════
//  SERIAL PROVISIONING
//  Called on first boot when no WiFi credentials are in NVS.
//  Prints the MAC address and waits for a JSON command.
//
//  Expected input (one line, newline-terminated):
//  {"cmd":"provision","wifi_ssid":"MyNet","wifi_pass":"secret","api_base":"https://..."}
//
//  Responds:
//  PROVISION_OK          — credentials saved, rebooting
//  PROVISION_FAIL:reason — something was wrong
//  PROVISION_TIMEOUT     — waited SERIAL_TIMEOUT_MS with no valid input
// ═════════════════════════════════════════════════════════════════════════════
...
// ═════════════════════════════════════════════════════════════════════════════
//  BMP STREAM RENDERER
//  Streams a 24-bit Windows BMP directly to the e-ink panel.
//  Buffers all rows in PSRAM (BMP is bottom-up; display needs top-down).
//  800×480×3 = 1.15 MB — fits in the 8 MB PSRAM with room to spare.
// ═════════════════════════════════════════════════════════════════════════════
...
// ═════════════════════════════════════════════════════════════════════════════
//  LOOP  — only active in POWER_MODE 1 or 2
// ═════════════════════════════════════════════════════════════════════════════
